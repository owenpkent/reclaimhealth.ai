        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/privacy" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Privacy
                </a>
              </li>
              <li>
                <a href="/terms" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Terms
                </a>
              </li>
            </ul>
