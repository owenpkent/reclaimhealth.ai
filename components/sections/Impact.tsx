          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-gray-600 dark:text-gray-300">Appeals</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">$100M+</div>
                <div className="text-gray-600 dark:text-gray-300">Care Restored</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">10+</div>
                <div className="text-gray-600 dark:text-gray-300">Partnerships</div>
              </div>
            </div>
          </div>
        </div>
